...
/// Сделай страницу восстановления пароля.
///
/// На почту будет отправлять письмо с кодом который надо будет ввести на этой
/// странице. после чего она предложит ввести новый пароль
class ForgetWidget extends StatefulWidget {
  const ForgetWidget({super.key});

  static String routeName = 'forget';
  static String routePath = '/forget';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'На вашу почту был отправлен код подтверждения. Введите его ниже для восстановления доступа.',
                            style: FlutterFlowTheme.of(context)
                                .headlineSmall
                                .override(
                                  fontFamily: 'Poppins',
